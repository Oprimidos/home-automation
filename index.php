...
<html lang="en">
    ...
    <body id="page-top">
        ...
        <header class="masthead">
            <div class="container">
                <div class="masthead-subheading">Welcome To M^2 HOME AUTOMATION SYSTEMS</div>
                <div class="masthead-heading text-uppercase">We are improving your house</div>
            ...
            <div class="container">
                <div class="text-center">
                    ...
                    <h3 class="section-subheading text-muted">What will you gain after start the use M^2</h3>
                </div>
                <div class="row text-center">
                    <div class="col-md-4">
                        ...
                        <p class="text-muted">Make your home smart</p>
                    </div>
                    <div class="col-md-4">
                        <span class="fa-stack fa-4x">
                            <i class="fas fa-circle fa-stack-2x text-primary"></i>
                    ...
                    <div class="col-md-4">
                        ...
                        <h4 class="my-3">Cheap</h4>
                        <p class="text-muted">Save lots of money</p>
                    </div>
                </div>
            </div>
        </section>
