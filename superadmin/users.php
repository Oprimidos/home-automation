...
<br>               
                ...
                <div class="container-fluid">
                    ...
                    <p class="mb-4">User Details and Delete Page</p>
                    ...
                    <div class="card shadow mb-4">
                        ...
                        <?php 
                        $sqluser=$db->prepare("SELECT userID,userFirstName,userLastName,userMail,userType,userHomeID FROM users");
                        $sqluser->execute();
                        $users = $sqluser->fetchAll(PDO::FETCH_ASSOC);
                        ?>
                        <div class="card-body">
                                ...
                                <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td><?php echo $user["userHomeID"] ?></td>
